  ...
  return (
    ...
    >
      <button
        ...
        className={`flex min-h-11 w-11 shrink-0 items-center justify-center rounded-xl border font-black disabled:cursor-not-allowed disabled:opacity-40 ${t.cardBg} ${t.cardBorder} ${t.mainText}`}
      >
        ‹
      </button>
