          ...
          return (
            <article key={facility.id} data-testid="parking-result" className={`rounded-2xl border p-3 ${selected ? selectedTone : t.cardBorder}`}>
              ...
              <div className="mt-2 flex gap-2">
                <button type="button" disabled={!canEdit} onClick={() => onSave(facility)} className="min-h-11 flex-1 rounded-xl bg-blue-700 px-2 text-[10px] font-black text-white transition-colors hover:bg-blue-800 disabled:cursor-not-allowed disabled:opacity-50">設為此景點停車場</button>
