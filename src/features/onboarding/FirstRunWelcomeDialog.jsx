...
const STEPS = [
  {
    title: '歡迎使用智の旅行',
    description: '行程、地圖、票券、記帳、清單與旅伴協作集中在同一旅程。',
  },
  {
    title: '用適合裝置的方式規劃',
    description: '手機使用單日時間軸；桌面使用多日並排畫面。',
  },
  {
    title: '從地圖掌握移動順序',
    description: '地圖依當日順序顯示景點，標記、卡片與日期同步。',
  },
  {
    title: '集中管理票券與旅費',
    description: '保存票券與附件、記錄共同支出，並標記轉帳完成狀態。',
  },
  {
    title: '先試範例，或建立自己的旅程',
    description: '範例可編輯且只保存在本機；正式旅程可分享即時協作。',
  },
];
